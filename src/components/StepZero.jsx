	...
	render() {
		return (
			...
			<div className="col-sm-12 col-md-10 offset-md-1">
				...
				<p>
					If you have fever, cough, runny nose, or sore throat, the Department of Health (DOH) encourages you
					to self-isolate for 14 days.
				</p>
				<p>
					If you have to go out, wash your hands frequently and keep a distance of 2 metres from others
					(social distancing).
				</p>
				...
				<div>
					...
					<ul>
						<li><a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019" role="link">World
							Health
							Organization</a> – World Health
							Organization’s official webpage regarding COVID-19
						</li>
						<li><a href="https://www.doh.gov.ph/2019-nCoV" role="link">Department of Health</a> – Learn
							about
							COVID-19
						...
						<li><a href="/faq" role="link">Frequently Asked Questions</a></li>
						<li><a href="/contact" role="link">Hotline Directory</a></li>
					</ul>
				</div>
				<br/>
				<p><strong>Disclaimer:</strong> Information on this website is adapted from <a
					href="https://www.doh.gov.ph/sites/default/files/basic-page/DecisionTool3a_original.jpg"
					role="link">DOH guidelines</a> for triaging COVID-19
